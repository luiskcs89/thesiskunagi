...
public class ScrumModelApplication extends AGeneratorApplication {
	...
	private EntityModel acceptanceCriteriaModel;

	public EntityModel getAcceptanceCriteriaModel() {
		if (acceptanceCriteriaModel == null) {
			acceptanceCriteriaModel = createEntityModel("AcceptanceCriteria", "sprint");
			acceptanceCriteriaModel.setGwtSupport(true);
			acceptanceCriteriaModel.addPredicate("editable");
			acceptanceCriteriaModel.addReference("requirement", getRequirementModel()).setMaster(true);
			acceptanceCriteriaModel.addProperty("number", int.class);
			acceptanceCriteriaModel.addStringProperty("label").setMandatory(true).setEditablePredicate("editable")
					.setSearchable(true).setTooltip(createLabelTooltipText("Acceptance Criteria"));
			acceptanceCriteriaModel
					...
					.setSearchable(true)
					.setTooltip(
						"The description of an Acceptance Criteria may be used to give information that is important, "
								+ "but cannot be inferred from the Label. "
								+ "As Acceptance Criteria are small units of work, the Label might be sufficient.");
			getApplicationModel().addCreateAction(acceptanceCriteriaModel);
			acceptanceCriteriaModel.addAction("DeleteAcceptanceCriteria");
		}

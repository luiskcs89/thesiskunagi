...
public abstract class GDao
    ...
    protected Map<String, scrum.client.sprint.AcceptanceCriteria> acceptanceCriterias = new HashMap<String, scrum.client.sprint.AcceptanceCriteria>();

    public final void clearAcceptanceCriterias() {
        ilarkesto.core.logging.Log.DEBUG("Clearing AcceptanceCriterias");
        acceptanceCriterias.clear();
    }

    public final boolean containsAcceptanceCriteria(scrum.client.sprint.AcceptanceCriteria acceptanceCriteria) {
        return acceptanceCriterias.containsKey(acceptanceCriteria.getId());
    }

    public final void deleteAcceptanceCriteria(scrum.client.sprint.AcceptanceCriteria acceptanceCriteria) {
        acceptanceCriterias.remove(acceptanceCriteria.getId());
        entityDeleted(acceptanceCriteria);
    }

    public final void createAcceptanceCriteria(scrum.client.sprint.AcceptanceCriteria acceptanceCriteria, Runnable successAction) {
        acceptanceCriterias.put(acceptanceCriteria.getId(), acceptanceCriteria);
        entityCreated(acceptanceCriteria, successAction);
    }

    public final void createAcceptanceCriteria(scrum.client.sprint.AcceptanceCriteria acceptanceCriteria) {
        acceptanceCriterias.put(acceptanceCriteria.getId(), acceptanceCriteria);
        entityCreated(acceptanceCriteria, null);
    }

    protected scrum.client.sprint.AcceptanceCriteria updateAcceptanceCriteria(Map data) {
        String id = (String) data.get("id");
        scrum.client.sprint.AcceptanceCriteria entity = acceptanceCriterias.get(id);
        if (entity == null) {
            entity = new scrum.client.sprint.AcceptanceCriteria(data);
            acceptanceCriterias.put(id, entity);
            ilarkesto.core.logging.Log.DEBUG("AcceptanceCriteria received: " + entity.getId() + " ("+entity+")");
        } else {
            entity.updateProperties(data);
            ilarkesto.core.logging.Log.DEBUG("AcceptanceCriteria updated: " + entity);
        }
        return entity;
    }

    public final scrum.client.sprint.AcceptanceCriteria getAcceptanceCriteria(String id) {
        scrum.client.sprint.AcceptanceCriteria ret = acceptanceCriterias.get(id);
        if (ret == null) throw new ilarkesto.gwt.client.EntityDoesNotExistException(id);
        return ret;
    }

    public final Set<scrum.client.sprint.AcceptanceCriteria> getAcceptanceCriterias(Collection<String> ids) {
        Set<scrum.client.sprint.AcceptanceCriteria> ret = new HashSet<scrum.client.sprint.AcceptanceCriteria>();
        for (String id : ids) {
            scrum.client.sprint.AcceptanceCriteria entity = acceptanceCriterias.get(id);
    ...
    public final List<scrum.client.sprint.AcceptanceCriteria> getAcceptanceCriterias() {
        return new ArrayList<scrum.client.sprint.AcceptanceCriteria>(acceptanceCriterias.values());
    }

    public final List<scrum.client.sprint.AcceptanceCriteria> getAcceptanceCriteriasByRequirement(scrum.client.project.Requirement requirement) {
        List<scrum.client.sprint.AcceptanceCriteria> ret = new ArrayList<scrum.client.sprint.AcceptanceCriteria>();
        for (scrum.client.sprint.AcceptanceCriteria entity : acceptanceCriterias.values()) {
            if (entity.isRequirement(requirement)) ret.add(entity);
        }
        return ret;
    }

    public final List<scrum.client.sprint.AcceptanceCriteria> getAcceptanceCriteriasByNumber(int number) {
        List<scrum.client.sprint.AcceptanceCriteria> ret = new ArrayList<scrum.client.sprint.AcceptanceCriteria>();
        for (scrum.client.sprint.AcceptanceCriteria entity : acceptanceCriterias.values()) {
    ...
    public final List<scrum.client.sprint.AcceptanceCriteria> getAcceptanceCriteriasByLabel(java.lang.String label) {
        List<scrum.client.sprint.AcceptanceCriteria> ret = new ArrayList<scrum.client.sprint.AcceptanceCriteria>();
        for (scrum.client.sprint.AcceptanceCriteria entity : acceptanceCriterias.values()) {
    ...
    public final List<scrum.client.sprint.AcceptanceCriteria> getAcceptanceCriteriasByDescription(java.lang.String description) {
        List<scrum.client.sprint.AcceptanceCriteria> ret = new ArrayList<scrum.client.sprint.AcceptanceCriteria>();
        for (scrum.client.sprint.AcceptanceCriteria entity : acceptanceCriterias.values()) {
    ...
    protected final Collection<Map<String, ? extends AGwtEntity>> getEntityMaps() {
        if (entityMaps == null) {
            ...
            entityMaps.add(acceptanceCriterias);
    ...
    protected final ilarkesto.gwt.client.AGwtEntity updateLocalEntity(String type, Map data) {
        if (type.equals(scrum.client.sprint.AcceptanceCriteria.ENTITY_TYPE)) {
            return updateAcceptanceCriteria(data);
        }
    ...
    public final Map<String, Integer> getEntityCounts() {
        ...
        ret.put("AcceptanceCriteria", acceptanceCriterias.size());

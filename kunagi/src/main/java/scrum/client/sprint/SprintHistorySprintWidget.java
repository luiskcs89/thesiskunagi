...
public class SprintHistorySprintWidget extends AScrumWidget {
	...
	public boolean selectAcceptanceCriteria(AcceptanceCriteria acceptanceCriteria) {
		update();
		RequirementInHistoryBlock rBlock = (RequirementInHistoryBlock) requirementList.getBlock(acceptanceCriteria
				.getRequirement());
		requirementList.extendBlock(rBlock, true);
		return rBlock.selectAcceptanceCriteria(acceptanceCriteria);
	}

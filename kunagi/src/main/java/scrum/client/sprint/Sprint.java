...
public class Sprint extends GSprint implements ForumSupport, ReferenceSupport, LabelSupport {
	...
	private transient Comparator<AcceptanceCriteria> acceptanceCriteriaOrderComparator;
	...
	public Comparator<AcceptanceCriteria> getAcceptanceCriteriaOrderComparator() {
		if (acceptanceCriteriaOrderComparator == null)
			acceptanceCriteriaOrderComparator = new Comparator<AcceptanceCriteria>() {

				@Override
				public int compare(AcceptanceCriteria a, AcceptanceCriteria b) {
					Requirement ar = a.getRequirement();
					Requirement br = b.getRequirement();
					if (ar != br) return getRequirementsOrderComparator().compare(ar, br);
		...
		return acceptanceCriteriaOrderComparator;
	}
